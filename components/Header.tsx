...
const Header: React.FC<HeaderProps> = ({ isDarkMode, toggleDarkMode, onSelectKey, apiKeySet, mode, onModeChange }) => {
  ...
  return (
    <header className="bg-white/60 backdrop-blur-xl dark:bg-zinc-950/60 px-3 py-2 sm:px-4 sm:py-2.5 flex items-center border-b border-zinc-200/50 dark:border-zinc-700/40 sticky top-0 z-50 transition-colors duration-200">
      ...
      <nav className="flex items-center bg-zinc-100/80 dark:bg-zinc-800/80 rounded-2xl p-1 gap-0.5 backdrop-blur-sm border border-zinc-200/50 dark:border-zinc-700/50 shadow-sm">
        {/* Ad Localizer */}
        <button
        ...
        <button
          ...
          className={`relative flex items-center gap-1.5 px-4 sm:px-5 py-2 rounded-xl text-xs sm:text-sm font-semibold transition-all duration-300 ease-out focus:outline-none focus:ring-2 focus:ring-zinc-400 dark:focus:ring-zinc-500 ${
            activeNav === 'alfred'
      ...
      <div className="flex items-center gap-1.5 sm:gap-2 flex-1 justify-end">
        <button
          onClick={onSelectKey}
          className={`px-2.5 sm:px-3 py-2 sm:py-1.5 rounded-xl text-xs sm:text-sm font-medium transition-colors focus:outline-none focus:ring-2 flex items-center gap-1.5 sm:gap-2 min-h-[36px] sm:min-h-[36px] ${
            apiKeySet
        ...
        <div className="relative" ref={menuRef}>
          <button
            ...
            className="p-2 sm:p-2 rounded-xl bg-zinc-100 dark:bg-zinc-900 text-zinc-600 dark:text-zinc-400 hover:bg-zinc-200 dark:hover:bg-zinc-800 transition-colors focus:outline-none focus:ring-2 focus:ring-zinc-900 dark:focus:ring-zinc-100 flex items-center gap-1.5 min-h-[36px] min-w-[36px] justify-center"
            title={t.language}
          >
        ...
        <button
          ...
          className="p-2 sm:p-2 rounded-xl bg-zinc-100 dark:bg-zinc-900 text-zinc-600 dark:text-zinc-400 hover:bg-zinc-200 dark:hover:bg-zinc-800 transition-colors focus:outline-none focus:ring-2 focus:ring-zinc-900 dark:focus:ring-zinc-100 min-h-[36px] min-w-[36px] flex items-center justify-center"
